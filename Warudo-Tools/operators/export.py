...
def apply_all(context: bpy.types.Context):
    target_objects = [
        collection_object
        for collection_object in context.collection.objects
        if collection_object.type in ["MESH", "ARMATURE"]
...
class WT_OT_WarudoFBXExport(bpy.types.Operator):
    ...
    def execute(self, context: bpy.types.Context):
        ...
        export_path = export_path.joinpath(f"{context.collection.name}.fbx")
